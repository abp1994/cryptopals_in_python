#-----setup file modified from pypa/sampleproject/blob/master/LICENSE.txt
#-----from https://github.com/pypa/sampleproject
#-----distribited under the MIT License
...
setup(
    ...
    description='A package that runs through the cryptopals challenges',  # Optional
    ...
    url='https://github.com/abp1994/cryptopals_in_python',  # Optional

    # This should be your name or the name of the organization which owns the
    # project.
    author='Akaash Bhardwaj Patel',  # Optional
    ...
    # larger catalog.
    keywords='cryptopals, cryptography, tutorial',  # Optional
