...
class Testbyte_operations(unittest.TestCase):
    def test_xor(self):
        ...
        self.assertEqual(bo.xor(b"\x00\x01\x01", b"\x00\x00\x01"), b"\x00\x01\x00")
    ...
    def test_edit_distance(self):
        ...
        self.assertEqual(bo.edit_distance(b"this is a test", b"this is a test"), 0)
        self.assertEqual(bo.edit_distance(b"this thing", b"that thing"), 4)
        self.assertEqual(bo.edit_distance(b"this is a test", b"wokka wokka!!!"), 37)
